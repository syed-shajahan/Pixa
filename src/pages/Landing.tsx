...
const Landing = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      let API_URL
      if (query) {
        API_URL = `https://api.unsplash.com/search/photos?query=${query}&client_id=${Access_Key}&page=${page}`
      } else {
        API_URL = `https://api.unsplash.com/photos/?client_id=${Access_Key}&page=${page}`
      }
